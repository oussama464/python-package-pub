...
setup(
    ...
    author="oussama missaoui",  # Type in your name
    author_email="ouss.miss@gmail.com",  # Type in your E-Mail
    url="https://github.com/oussama464/python-package-pub",  # Provide either the link to your github or to your website
